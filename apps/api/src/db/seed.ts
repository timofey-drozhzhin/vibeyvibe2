...
const attributesSeedData = [
  // GENRE
  { name: "genre", attribute_category: "genre", description: "Detailed genres from primary to least, ordered by greatest influence", instructions: "Start with a general genre, but then list genre specifics that makes this song different within it's own genre", examples: "Bubblegum Pop, Trap Metal, East Coast Boom-Bap, Street Rap" },
  { name: "era_influence", attribute_category: "genre", description: "Decade or period the sound draws from", instructions: "What era of music is this being influenced by? Start with the year, but list the specific style from that time period that influenced", examples: "late 80s synth-pop, 2010s SoundCloud rap, 70s Philly soul" },
  { name: "cultural_origin", attribute_category: "genre", description: "Regional or cultural roots and specific stylistic niche", instructions: "What culture and the style within the culture is this song being influenced by?", examples: "Korean idol pop, Lagos Afrobeat, European Italo-Disco, Caribbean Dancehall, Polska Polka" },

  // STRUCTURE
  { name: "song_structure", attribute_category: "structure", description: "Exact section-by-section flow of the song", instructions: "Identify the song structure. Is there an intro? Are there verses? Is there a chorus? List the entire structural flow.", examples: "Intro -> Verse 1 -> Pre-Chorus -> Chorus -> Verse 2 -> Pre-Chorus -> Chorus -> Bridge -> Final Chorus -> Outro" },
  { name: "verse_style", attribute_category: "structure", description: "Verse characteristics", instructions: "Examine the verses (if any). Identify the size of the verse, vocals (gender, vocal arrangement, ensemble size), weight (emotional intensity, energy, etc), repetition (does it repeat words, phrases or the entire thing, and how often)", examples: "long, structured as 2 parallel 4-line halves. Female, solo arrangement. Lighthearted, quirky and upbeat romantic energy." },
  { name: "chorus_style", attribute_category: "structure", description: "Chorus characteristics", instructions: "Examine the chorus (if any). Identify the size of the chorus, vocals (gender, vocal arrangement, ensemble size), weight (emotional intensity, energy, etc), repetition (does it repeat words, phrases or the entire thing, and how often)", examples: "short 4-bar. Upbeat, high energy and catchy. Male, solo arrangement. Repeats the beginning phrase twice." },
  { name: "intro_style", attribute_category: "structure", description: "Intro unique characteristics", instructions: "Examine the intro of the song, even if it doesn't have intro lyrics. Note the duration, instrumentation used. Does the music ease-in, or does it begin right away.", examples: "15-second slow fade-in. Ambient synth pads. 8-bar cold open of heavy guitar. 10-second acapella before sudden bass drop. Immediately starts with the verse." },
  { name: "outro_style", attribute_category: "structure", description: "How the song closes", instructions: "Examine the ending of the song. Determine if it ends on a definitive note, fades out, breaks down into specific elements. Note vocals, musical instrument, energy.", examples: "Abrupt heavy guitar stop. Low-energy solo piano decay. Crowd noise fade. High energy repeating chorus." },
  { name: "duration", attribute_category: "structure", description: "Total song length", instructions: "Identify the total running time of the audio provided. Note if it is a specific mix format based on length.", examples: "3:42, 7:12 extended mix" },
  { name: "energy_arc", attribute_category: "structure", description: "How dynamic energy rises and falls across the full timeline", instructions: "Map the intensity from start to finish. Identify the build, peak, drop, and resolution.", examples: "low simmering verse builds into explosive chorus, drops to near-silence at bridge, erupts into double-time final chorus, steady escalation from start to finish with no release" },
  { name: "transitions", attribute_category: "structure", description: "Type and feel of connections between sections", instructions: "Identify how the song moves between major sections. Note the techniques, fills, or effects used to bridge gaps.", examples: "riser sweeps into each chorus, drum fill transitions, silence gaps between verse and chorus, reversed vocal crossfade, beat drops out leaving only bass before chorus hits" },
  { name: "section_contrast", attribute_category: "structure", description: "How different sections feel from each other", instructions: "Compare distinct song parts. Highlight primary differences in instrumentation, vocal delivery, or energy.", examples: "rapped verses vs melodic sung chorus, acoustic verse into full-band chorus, whispered bridge against screamed chorus, kids church choir chorus vs street-rap verses" },

  // COMPOSITION
  { name: "key", attribute_category: "composition", description: "Musical key, scale, and mode", instructions: "Identify the primary tonal center of the song, including the root note and the specific scale or mode used.", examples: "C minor natural, F# Dorian, E major pentatonic" },
  { name: "tempo", attribute_category: "composition", description: "BPM, grid feel, and any fluctuation", instructions: "Determine the approximate beats per minute (BPM). Note if the tempo stays strict, fluctuates, or changes entirely during the song.", examples: "92 BPM tight grid, 140 BPM half-time feel, starts 70 BPM accelerates to 120 by final chorus, loose human tempo drift" },
  { name: "time_signature", attribute_category: "composition", description: "Rhythmic meter", instructions: "Identify the number of beats per measure and the note value that gets the beat. Note any odd meters or shifts in time signature.", examples: "4/4, 3/4 waltz, 6/8 compound, alternates 7/8 and 4/4" },
  { name: "chord_progression", attribute_category: "composition", description: "Specific chord sequences per section", instructions: "Analyze the underlying harmonic movement. Detail the chord patterns used in distinct sections using Roman numeral analysis or general descriptions.", examples: "verse: i-VI-III-VII, chorus: I-V-vi-IV; single chord drone throughout; jazz ii-V-I turnarounds with chromatic passing chords" },
  { name: "melody", attribute_category: "composition", description: "Core melodic hooks, contour, and motifs", instructions: "Describe the primary musical phrases sung or played. Focus on the shape of the melody, its catchiness, and how instruments interact with it.", examples: "descending minor pentatonic hook with call-and-response between vocal and synth, one-note chant melody, soaring octave-leap chorus hook" },

  // RHYTHM
  { name: "rhythmic_feel", attribute_category: "rhythm", description: "How the beat physically sits and moves", instructions: 'Describe the "pocket" or groove of the track. Is it rigid and quantized, or loose and swung?', examples: "straight and mechanical, swung 16ths, heavy syncopation, lazy behind-the-beat drag, tight and punchy" },
  { name: "drum_pattern", attribute_category: "rhythm", description: "Drum style, pattern, and character", instructions: "Identify the primary drum loop or beat. Note the specific kit type and the rhythmic pattern played by the kick, snare, and hi-hats.", examples: "trap hi-hats with rolling triplets, four-on-the-floor house kick, boom-bap breakbeat, live jazz brushes, no drums — percussion-free" },
  { name: "bass_groove", attribute_category: "rhythm", description: "Bass rhythm, character, and role", instructions: "Analyze the low-end foundation. Describe the tone of the bass instrument and how it interacts rhythmically with the drums.", examples: "808 sub-bass slides, fingerstyle Motown walking bass, distorted synth bass pulsing on downbeats, bass drops only on chorus" },
  { name: "percussion_elements", attribute_category: "rhythm", description: "Non-drum percussion adding texture", instructions: "Listen for auxiliary rhythmic instruments outside the main drum kit. Detail what they are and where they hit in the measure.", examples: "shaker and finger snaps on 2 and 4, tabla and hand drums, cowbell driving the groove, none" },

  // INSTRUMENTATION
  { name: "primary_instruments", attribute_category: "instrumentation", description: "Dominant instruments carrying the song", instructions: "Identify the main instruments that drive the melodic and harmonic foundation of the track.", examples: "detuned honky-tonk piano, 808 kit; clean electric guitar arpeggios, analog Moog bass" },
  { name: "secondary_instruments", attribute_category: "instrumentation", description: "Supporting or textural instruments", instructions: "Identify background instruments that add depth, color, or texture but do not lead the song.", examples: "ambient string pads, marimba accents; organ swells in chorus only; orchestral brass stabs" },
  { name: "instrument_technique", attribute_category: "instrumentation", description: "Specific playing styles, unorthodox methods, and what makes them different", instructions: "Listen for unique ways the instruments are physically played. Describe any distinct articulations or unconventional techniques.", examples: "palm-muted guitar with heavy pick scrapes, bowed electric bass, prepared piano with objects on strings, slap bass with thumb muting" },
  { name: "instrument_effects", attribute_category: "instrumentation", description: "Effects processing on instruments", instructions: "Detail any obvious audio effects applied to the instruments to change their natural tone.", examples: "heavy flanger on guitar, bit-crushed synth leads, reversed reverb piano swells, tremolo on Rhodes" },
  { name: "arrangement_dynamics", attribute_category: "instrumentation", description: "When and how instrumental elements enter, exit, and layer across the timeline", instructions: "Map how the instrumentation builds or strips away over time. Note specific sections where elements drop out or stack together.", examples: "drums drop out in verse 2, strings enter at bridge, full band at final chorus; instruments added one by one each 8 bars; everything cuts except vocals for 2 beats before chorus drops" },
  ...
  for (const attr of attributesSeedData) {
    ...
    if (existing.length > 0) {
      ...
      const needsUpdate =
        ...
        row.instructions !== (attr.instructions ?? null) ||
        row.examples !== (attr.examples ?? null) ||
        row.attribute_category !== attr.attribute_category;

      if (needsUpdate) {
        await db
          .update(songAttributes)
          .set({
            description: attr.description,
            instructions: attr.instructions ?? null,
            examples: attr.examples ?? null,
            attribute_category: attr.attribute_category,
            updated_at: new Date().toISOString(),
          })
          .where(eq(songAttributes.id, row.id));
        attrUpdated++;
      } else {
        attrUnchanged++;
      }
  ...
  for (const oldName of ["section_sizes"]) {
    ...
    if (existing.length > 0 && !existing[0].archived) {
      await db
        ...
        .where(eq(songAttributes.id, existing[0].id));
    }
  }

  console.log(`  Song attributes seeded (inserted: ${attrInserted}, updated: ${attrUpdated}, unchanged: ${attrUnchanged})`);
