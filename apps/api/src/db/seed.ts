...
const vibesSeedData = [
  ...
  { name: "era_influence", vibe_category: "genre", description: "Decade or period the sound draws from", instructions: "What era of music is this being influenced by? Start with the year, but list the specific style from that time period that influenced", examples: "late 80s synth-pop, 2010s SoundCloud rap, 70s Philly soul" },
  { name: "cultural_origin", vibe_category: "genre", description: "Regional or cultural roots and specific stylistic niche", instructions: "What culture and the style within the culture is this song being influenced by?", examples: "Korean idol pop, Lagos Afrobeat, European Italo-Disco, Caribbean Dancehall, Polska Polka" },

  // STRUCTURE
  { name: "song_structure", vibe_category: "structure", description: "Exact section-by-section flow of the song", instructions: "Identify the song structure. Is there an intro? Are there verses? Is there a chorus? List the entire structural flow.", examples: "Intro -> Verse 1 -> Pre-Chorus -> Chorus -> Verse 2 -> Pre-Chorus -> Chorus -> Bridge -> Final Chorus -> Outro" },
  { name: "verse_style", vibe_category: "structure", description: "Verse characteristics", instructions: "Examine the verses (if any). Identify the size of the verse, vocals (gender, vocal arrangement, ensemble size), weight (emotional intensity, energy, etc), repetition (does it repeat words, phrases or the entire thing, and how often)", examples: "long, structured as 2 parallel 4-line halves. Female, solo arrangement. Lighthearted, quirky and upbeat romantic energy." },
  { name: "chorus_style", vibe_category: "structure", description: "Chorus characteristics", instructions: "Examine the chorus (if any). Identify the size of the chorus, vocals (gender, vocal arrangement, ensemble size), weight (emotional intensity, energy, etc), repetition (does it repeat words, phrases or the entire thing, and how often)", examples: "short 4-bar. Upbeat, high energy and catchy. Male, solo arrangement. Repeats the beginning phrase twice." },
  { name: "intro_style", vibe_category: "structure", description: "Intro unique characteristics", instructions: "Examine the intro of the song, even if it doesn't have intro lyrics. Note the duration, instrumentation used. Does the music ease-in, or does it begin right away.", examples: "15-second slow fade-in. Ambient synth pads. 8-bar cold open of heavy guitar. 10-second acapella before sudden bass drop. Immediately starts with the verse." },
  { name: "outro_style", vibe_category: "structure", description: "How the song closes", instructions: "Examine the ending of the song. Determine if it ends on a definitive note, fades out, breaks down into specific elements. Note vocals, musical instrument, energy.", examples: "Abrupt heavy guitar stop. Low-energy solo piano decay. Crowd noise fade. High energy repeating chorus." },
  ...
  { name: "section_contrast", vibe_category: "structure", description: "How different sections feel from each other", instructions: "Compare distinct song parts. Highlight primary differences in instrumentation, vocal delivery, or energy.", examples: "rapped verses vs melodic sung chorus, acoustic verse into full-band chorus, whispered bridge against screamed chorus, kids church choir chorus vs street-rap verses" },
  ...
  { name: "time_signature", vibe_category: "composition", description: "Rhythmic meter", instructions: "Identify the number of beats per measure and the note value that gets the beat. Note any odd meters or shifts in time signature.", examples: "4/4, 3/4 waltz, 6/8 compound, alternates 7/8 and 4/4" },
  { name: "chord_progression", vibe_category: "composition", description: "Specific chord sequences per section", instructions: "Analyze the underlying harmonic movement. Detail the chord patterns used in distinct sections using Roman numeral analysis or general descriptions.", examples: "verse: i-VI-III-VII, chorus: I-V-vi-IV; single chord drone throughout; jazz ii-V-I turnarounds with chromatic passing chords" },
  ...
  { name: "vocal_accent", vibe_category: "vocals", description: "Cultural, regional, or dialectal inflection", instructions: "Listen for any specific regional accents or cultural dialects present in the pronunciation of the words.", examples: "Southern US drawl, heavy New York street inflection, Caribbean Patois flavor, London roadman cadence, AAVE with Trinidadian accent, neutral/no notable accent" },
  { name: "vocal_effects", vibe_category: "vocals", description: "Processing and effects on the voice", instructions: "Detail any obvious studio effects applied to the lead vocals.", examples: "heavy autotune, dry with no reverb, vocoder harmonies, telephone EQ filter on verse, heavy slapback delay" },
  ...
  // PRODUCTION
  { name: "production_style", vibe_category: "production", description: "Overall sonic approach and era", instructions: "Describe the overarching aesthetic of the recording and production. Does it sound modern, retro, clean, or gritty?", examples: "polished maximalist pop, lo-fi bedroom with tape hiss, raw live recording, hyper-processed futuristic, stripped acoustic" },
  { name: "mix_character", vibe_category: "production", description: "Sonic quality, vocal placement, and depth", instructions: "Analyze the frequency balance and spatial depth of the mix. Note where the vocals sit relative to the instrumental.", examples: "vocal up front and dry, intimate feel; vocals buried in reverb wall, stadium sound; bass-heavy low-end dominant; bright and crispy highs" },
  { name: "stereo_field", vibe_category: "production", description: "Panning and spatial layout", instructions: "Listen to the left and right channels. Describe how wide the mix is and if specific elements are panned aggressively.", examples: "guitars hard-panned left and right, drums dead center; wide immersive stereo; narrow mono-focused; elements ping-pong between channels" },
  { name: "sound_design", vibe_category: "production", description: "Non-musical sounds, foley, and sonic textures", instructions: "Identify any environmental sounds, noises, or purely textural audio elements that aren't traditional instruments.", examples: "vinyl crackle throughout, rain and thunder in intro, glitch artifacts and digital noise, field recording of city traffic under verse, none" },
  ...
  // MOOD
  { name: "overall_mood", vibe_category: "mood", description: "Overarching emotional atmosphere in precise terms", instructions: "Summarize the primary emotion or feeling the track evokes in the listener.", examples: "euphoric, creeping dread, simmering tension, bittersweet nostalgia, manic and frantic, anthemic and triumphant" },
  ...
  { name: "energy_texture", vibe_category: "energy", description: "Physical quality and shape of the energy", instructions: "Use tactile adjectives to describe how the energy of the song feels.", examples: "bouncy and springy, heavy and grinding, floaty and weightless, jagged and angular, smooth and flowing, sticky and syrupy" },
